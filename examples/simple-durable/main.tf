...
module "lambda_function" {
  ...
  function_name = "${random_pet.this.id}-lambda-durable"
  handler       = "index.lambda_handler"
  runtime       = "python3.13"

  durable_config_execution_timeout = 300
  ...
  source_path = [
    #{
    #      pip_requirements = "${path.module}/../fixtures/python-app1/requirements.txt"
    #      pip_requirements = "${path.module}/../fixtures/python-durable/requirements.txt"
    #},
    "${path.module}/../fixtures/python-durable/index.py",
    #    {
